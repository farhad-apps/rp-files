...
const FullSync = {
    run: async () => {
        ...
        if (cfg.xrayEnabled && data.xray_full_config) {
            const { xray_full_config } = data;
            fs.writeFileSync(config.xray.config_path, JSON.stringify(xray_full_config, null, 2), "utf8");
